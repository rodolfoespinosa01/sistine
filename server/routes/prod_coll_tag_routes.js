...
router.post("/product", isAuthenticated, product_controller.newProduct)

//POST(/collection): Create a set of new products, all within one collection. Can't create an empty collection.
router.post("/collection", isAuthenticated, collection_controller.newCollection)

//POST(/tag): Create a new tag
router.post("/tag", isAuthenticated, tag_controller.newTag);
...
router.route('/product/:product_id')
    ...
    .put(isAuthenticated, product_controller.updateProductById)
    .delete(isAuthenticated, product_controller.deleteProductById)
...
router.route('/collection/:collection_id')
    ...
    .put(isAuthenticated, collection_controller.updateCollectionById)
    .delete(isAuthenticated, collection_controller.deleteCollectionById)
